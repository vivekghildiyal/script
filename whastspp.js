    ...
    function initWidget(){
        ...
        jQuery('body').append(`<div id="whatsapp_chat_widget">
            <div id="wa-widget-send-button">
                <img src="https://cdn.jsdelivr.net/gh/vivekghildiyal/script@main/whatsapp.svg" alt="Whatsapp Chat">
        ...
        jQuery('#whatsapp_chat_widget').append(`
            <div class='wa-chat-box'>
                ...
                <div class='wa-chat-box-send'>
                    ...
                    <div class='wa-chat-box-poweredby'>Powered by <a href="https://theboyo.com/?utm_source=shopify&utm_medium=chat_widget&utm_campaign=shopify_widget" target="_blank" style="color: #006eff6e;">Boyo</a></div>
                </div>
            </div>
        `);
